                        ...
                        <form class="col s12" method="POST" enctype="multipart/form-data" action="/iklan/update/{{ $data->id }}">
                            ...
                            <div class="row">
                                <div class="input-field col s6">
                                    <input id="last_name" type="text" class="validate" name="judul" value="{{ $data->judul }}">
                                    <label for="nama_iklam" class="active">Nama Iklan</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s6">
                                    <input type="file" class="custom-file-input" name="image" class="validate" value="{{ $data->image }}">
